...
# define ERROR_ARGS "Error\nUsage: ./miniRT_bonus scenes/<scene.rt>\n"
...
void			display_hyperbolic_paraboloid_properties(t_data *data,
					t_object *obj);
...
t_point			get_h_p_vertex(double h_p_abcdefg[7]);
...
void			setup_hooks(t_minilibx *mlx_struct, t_data *data);
